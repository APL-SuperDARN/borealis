    ...
    * interface:    modifiable using the add_slice, edit_slice, and del_slice methods, or by
    ...
    def __init__(
        ...
        self.__transmit_metadata = {
            ...
            "mccm_main_rx_calibration_file": self.options.mccm_main_rx_calibration_file,
            "mccm_main_rx_calibration_antennas": self.options.mccm_main_rx_calibration_applied_antennas,
            "mccm_main_rx_calibration_reference_antenna": self.options.mccm_main_rx_calibration_reference_antenna,
            "mccm_main_rx_corrections": self.options.mccm_main_rx_corrections,
